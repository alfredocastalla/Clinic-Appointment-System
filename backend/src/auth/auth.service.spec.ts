...
describe('AuthService', () => {
  ...
  describe('registerDoctor', () => {
    ...
    it('should throw error if doctor already exists', async () => {
      ...
      await expect(service.registerDoctor(doctorData)).rejects.toThrow(
        UnauthorizedException,
      );
    });
  });
  ...
  describe('login', () => {
    ...
    it('should throw error for invalid credentials - user not found', async () => {
      ...
      await expect(
        service.login('invalid@example.com', 'password', 'user'),
    ...
    it('should throw error for invalid password', async () => {
      ...
      await expect(
        service.login('john@example.com', 'wrongpassword', 'user'),
      ).rejects.toThrow(UnauthorizedException);
    });
